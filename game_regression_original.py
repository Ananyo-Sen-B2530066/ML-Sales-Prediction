# -*- coding: utf-8 -*-
"""
Created on Tue Nov 18 20:32:47 2025
...
sns.barplot(data=results1_df.melt(id_vars='Model', value_vars=['Val_R²','Test_R²']),
...
for name, model in models.items():
    ...
    plt.figure(figsize=(6, 4))
    sns.scatterplot(x=y_test, y=real_y_pred, alpha=0.6)
